...
router.get('/:photoId/delete', isAuth, async (req, res) => {
    ...
    try {
        ...
        res.render(`photos/details`, {error: 'Photo deletion failed'})
    }
...
router.get('/:photoId/edit', isAuth, async (req, res) => {
    ...
    try {
        ...
        res.render(`photos/details`, {error: 'Cannot find pet'})
    }
...
router.post('/:photoId/comments', isAuth, async (req, res) => {
    ...
    try {
        ...
        res.render('photos/details', { error: 'Unable to post comment'})
    }
});
